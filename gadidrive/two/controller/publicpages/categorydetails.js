...
exports.getcategorydetails = async (req, res, next) => {
    try {
        ...
        if (category && category.name.toLowerCase() === 'sportcar') {
            category.name = 'Sports Car';
        }
        ...
        res.render('publicpages/categorydetails', {
            ...
            title: `All ${category.name} ${pluralType} in ${countryDisplay}`,
            ogImage: category.image_path || '/images/mainlogo.png',
